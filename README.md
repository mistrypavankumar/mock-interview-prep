...
- [pnpm](https://pnpm.io/) (Performant Node Package Manager used for Fast, disk space efficient)

**Cloning the Repository**

```bash
git clone https://github.com/mistrypavankumar/mock-interview-prep
cd mock-interview-prep
```
